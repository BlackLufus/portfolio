...
import EventListener from "../assets/EventListener";
...
class Frame {
     ...
     */
    constructor(titleText: string, terminateEvent?: () => void) {
    ...
    public build(content: React.ReactNode): React.ReactNode {
        return (
            <div ref={this.frameRef} className="frame" style={{ zIndex: Frame.zCounter }}>
                <header className="frame_header">
                    <span ref={this.frameHeaderRef} className="frame_title">
                        {this.titleText}
                    </span>

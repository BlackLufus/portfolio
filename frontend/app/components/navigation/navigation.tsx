            ...
            <div className={`navi_bar_wrapper ${menuState ? "show": ""}`}>
                ...
                <div className="navi_bar_right">
                    ...
                    <div onClick={handleDarkmodeClick} className="nav_action">
                        <svg className={`nav_action_item ${darkmodeState ? "" : "show"}`} fill="#fff" width="35px" height="35px" viewBox="0 -4.5 33 33" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg className={`nav_action_item ${darkmodeState ? "show" : ""}`} fill="#000" width="35px" height="35px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

        ...
        <div className={`education_panel ${class_name}`}>
            ...
            <div className="education_panel_wraper">
                ...
                <div className="education_panel_institution">
                    <svg className="education_institution_icon" width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 className="education_institution">
                        {data.institution}
                    </h5>
                </div>
                ...
                {data.additionalInfo
                    ? <p className="education_additional_info">
                        {data.additionalInfo}
                    </p>
                    : null
                }
